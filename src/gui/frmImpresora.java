...
private Usuario objUsuarioAdmin = new Usuario();
    ...
    public frmImpresora(Usuario usuario) {
        initComponents();
              ...
              public void listarComboDepartamento()
    {
        ...
        try {
         ...
         public void listarComboImpresora()
    {
        ComboImpresora.removeAllElements();
        ComboImpresora.addElement("(Seleccione una Opcion)");
         try {
            List<Componente> listComponente = objComponenteCOM.listarComponentesxUbicacion(5,1);
       ...
       public void limpiarControles()
    {
      ...
      cb_ListarImpresora.setSelectedIndex(0);
    ...
    private void initComponents() {
        ...
        lblNPImpresora = new javax.swing.JLabel();
        ...
        setTitle("Formulario de Ingreso de Impresora");
        setAlwaysOnTop(true);
        setResizable(false);
        ...
        jLabel1.setText("Ingreso de Impresora");

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/impresora.png"))); // NOI18N
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Impresora", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12))); // NOI18N

        jLabel21.setFont(new java.awt.Font("Arial", 1, 12));
        jLabel21.setText("Nro. Patrimonial :");

        txtIdImpresora.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtIdImpresoraKeyReleased(evt);
            }
        });
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addComponent(txtIdImpresora, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(lblNPImpresora, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(cb_ListarImpresora, 0, 360, Short.MAX_VALUE))
                .addContainerGap())
        );
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel21)
                        .addComponent(txtIdImpresora, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(lblNPImpresora, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
// TODO add your handling code here:
    ...
    if(!txtIdImpresora.getText().equals("") && cb_ListarImpresora.getSelectedIndex()!=0 && cb_ListarEmpleado.getSelectedIndex()!=0)
     {
        try {
        Impresora objImpresora = new Impresora();
        objImpresora.setStr_id_impresora(txtIdImpresora.getText());
        objImpresora.setObjComponente(((Componente)cb_ListarImpresora.getSelectedItem()));
        objImpresora.setInt_estado(0);
        objImpresora.setObjEmpleado(((Empleado)cb_ListarEmpleado.getSelectedItem()));
         if(objCPatrimonialCOM.insertar(txtIdImpresora.getText()))
         if(objImpresoraCOM.insertar(objImpresora))
...
private void txtIdImpresoraKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIdImpresoraKeyReleased
        try {
            // TODO add your handling code here:
                if(!"".equals(objCPatrimonialCOM.verificarNSerie(txtIdImpresora.getText())))
                {
                     txtIdImpresora.setBackground(Color.red);
                     lblNPImpresora.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/cancel.png")));
                     lblNPImpresora.setToolTipText("El Codigo Patrimonial es Repetido");
                }
                else{
                    txtIdImpresora.setBackground(Color.white);
                    lblNPImpresora.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/aceptar_check.gif")));
                    lblNPImpresora.setToolTipText("El Campo Es Correcto");
                }
...
}//GEN-LAST:event_txtIdImpresoraKeyReleased
    ...
    private javax.swing.JLabel lblNPImpresora;
