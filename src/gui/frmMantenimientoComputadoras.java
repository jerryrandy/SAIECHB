...
import com.*;
import entidades.*;
import gui.Computador.frmMostrarComputadora;
 ...
 * @author Toditos
 */
public class frmMantenimientoComputadoras extends javax.swing.JFrame {

    private Usuario objUsuarioAdmin = new Usuario();
    boolean siguiente=true;
    
       private ComputadorCOM objComputadorCOM= new ComputadorCOM(); 
     private ModeloComputador modeloComputador = new ModeloComputador();
    
    /** Creates new form frmPortatil */
    public frmMantenimientoComputadoras(Usuario usuario) {
        initComponents();
        this.setIconImage (new ImageIcon(getClass().getResource("/imagenes/icono.png")).getImage()); 
         setLocationRelativeTo(null);
         this.objUsuarioAdmin = usuario;
          tablaComputador.setModel(modeloComputador);
           tablaComputador.getColumnModel().getColumn(0).setMaxWidth(110);
         tablaComputador.getColumnModel().getColumn(0).setMinWidth(110);
          tablaComputador.getColumnModel().getColumn(1).setMaxWidth(150);
         tablaComputador.getColumnModel().getColumn(1).setMinWidth(150);
          tablaComputador.getColumnModel().getColumn(2).setMaxWidth(130);
         tablaComputador.getColumnModel().getColumn(2).setMinWidth(130);
           tablaComputador.getColumnModel().getColumn(3).setMaxWidth(170);
         tablaComputador.getColumnModel().getColumn(3).setMinWidth(170);
...
ListarComputdoras();
    ...
    {
          try {
            modeloComputador.limpiar();
            List<Computador> listaComputador=objComputadorCOM.listarTodosOrdenado(0);
            if(listaComputador!=null)
            {
            modeloComputador.insertarLista(listaComputador);
            modeloComputador.fireTableDataChanged();
            }
    ...
    private void initComponents() {
        ...
        tablaComputador = new javax.swing.JTable();
        ...
        tablaComputador.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaComputador.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        jScrollPane1.setViewportView(tablaComputador);
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
     ...
     if(!txtBuscar.getText().equals(""))
        try {
              modeloComputador.limpiar();
            List<Computador> listaComputador=objComputadorCOM.listarFiltro(txtBuscar.getText());
            if(listaComputador!=null)
            {
            modeloComputador.insertarLista(listaComputador);
            modeloComputador.fireTableDataChanged();
    ...
    private void btnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarActionPerformed
        ...
        if(tablaComputador.getSelectedRow()>=0)
        {
      
                Computador objComputador = new Computador();
                        objComputador = modeloComputador.listar().get(tablaComputador.getSelectedRow());
    ...
    private javax.swing.JTable tablaComputador;
