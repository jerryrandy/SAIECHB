...
public class frmMarca extends javax.swing.JFrame {
    ...
    private MarcaCOM objMarcaCOM = new MarcaCOM();
     private DefaultListModel modeloMarca = new DefaultListModel();
     private boolean principal=true;
     
    public frmMarca(Usuario usuario,boolean Principal) {
        initComponents();
        this.principal=Principal;
        this.objUsuarioAdmin = usuario;
           this.setIconImage (new ImageIcon(getClass().getResource("/imagenes/icono.png")).getImage()); 
          setLocationRelativeTo(null);
        jListaMarca.setModel(modeloMarca);
        listarMarca();
    }
      public void listarMarca()
    {
        modeloMarca.clear();
        try {
            List<Marca> listMarca = objMarcaCOM.listarTodosOrdenado();
            if(listMarca!=null)
            {
       ...
       public void limpiarControles()
    {
        ...
        txtNombre.setText("");
        txtBuscar.setText("");
        lblIdMarca.setText("Autogenerado");  
    ...
    private void initComponents() {
        ...
        jListaMarca = new javax.swing.JList();
        ...
        setTitle("Formulario de Mantenimiento de Marca");
        setAlwaysOnTop(true);
        setResizable(false);
        ...
        jListaMarca.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jListaMarcaMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jListaMarca);
...
private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
    ...
    if(lblIdMarca.getText().equals("Autogenerado"))
    {
     if(txtNombre.getText() == null ? "" != null : !txtNombre.getText().equals("") )
        ...
        try {
            ...
            objMarca.setIntl_activa(cboEstado.getSelectedIndex());

            objMarca.setStr_nombre(txtNombre.getText());

             
            objMarca.setStr_descripcion(txtDescripcion.getText());
            
            
            if(objMarcaCOM.insertar(objMarca))
            {
...
private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
    ...
    if(!lblIdMarca.getText().equals("Autogenerado"))
      try {
            ...
            objMarca.setInt_id_marca(Integer.parseInt(lblIdMarca.getText()));
            
            if(objMarcaCOM.actualizar(objMarca))
            {
...
private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
     ...
     if(!lblIdMarca.getText().equals("Autogenerado"))
        {
            try {
            if(objMarcaCOM.eliminar(Integer.parseInt(lblIdMarca.getText())))
            {
...
private void jListaMarcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jListaMarcaMouseClicked

       String criterio = jListaMarca.getSelectedValue().toString();
       if(!criterio.toString().trim().equals(""))
       {
                
                txtNombre.setText(((Marca)jListaMarca.getModel().getElementAt(jListaMarca.getSelectedIndex())).getStr_nombre());
                txtDescripcion.setText(((Marca)jListaMarca.getModel().getElementAt(jListaMarca.getSelectedIndex())).getStr_descripcion());
                lblIdMarca.setText(String.valueOf(((Marca)jListaMarca.getModel().getElementAt(jListaMarca.getSelectedIndex())).getInt_id_marca()));
                cboEstado.setSelectedIndex((((Marca)jListaMarca.getModel().getElementAt(jListaMarca.getSelectedIndex())).getIntl_activa()));

       }
    
}//GEN-LAST:event_jListaMarcaMouseClicked

private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
// TODO add your handling code here:
      modeloMarca.clear();
        try {
            List<Marca> listMarca = objMarcaCOM.listarFiltro(txtBuscar.getText());
            if(listMarca!=null)
            {
                for(Marca m : listMarca)
                {
...
// TODO add your handling code here:
    ...
    private javax.swing.JList jListaMarca;
